  ...
  return (
    <section className="main-container">
        <Card>
            <h1>About</h1>
            <h2>The Idea</h2>
            <p>BetterBriefs a website for  programmers who want to improve their programming skills without thinking about an project idea and concept. The main goal for the user is to build a website with the given criterias and needs of the persona. The user will get a random generated brief including how the website should look like and who wants it. The user should be able to start programming after reading the generated proposal without thinking about a concept.</p>
            <p>The main part is to get a realistic random generated brief, which is easy to understand. Features like "add to favorites" etc. are also available.</p>
...
>>>>>>> bafdf30e1fe635947e7f7f17929a87c0658bd636
