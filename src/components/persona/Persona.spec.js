...
person.sex = true;
person.age = 53;
person.about = "Helen is one of the craziest persons in her friendzone. Since she's been 16, every year she visits at least three heavy metal festivals. She travels around the world to watch all her favourite musicians at concerts. When she's at home, she spends her time on gardening and listening to loud music.";
...
describe('Brief Persona', () => {
    it("When a Brief Persona is Generated and renderd, The persona name should be renderd", () => {
        //Act
        ReactDOM.render(<Persona personaUrl={personAvatarUrl} persona={person}></Persona>, container);
