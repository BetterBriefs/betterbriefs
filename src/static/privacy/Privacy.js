<<<<<<< Updated upstream:src/components/privacy/Privacy.js
    ...
    <section className="main-container">
      <Card>
        ...
        <p>
          ...
          by BetterBriefs and how we use it.
        </p>
        <p>
          If you have additional questions or require more information about our
          Privacy Policy, do not hesitate to contact us through email at{" "}
          <a href="mailto://email@araz.dev">email@araz.dev</a>
        </p>
        ...
        <h2>Log Files</h2>
        <p>
          BetterBriefs follows a standard procedure of using log files. These
        ...
        <p>
          ...
          shared and/or collect in BetterBriefs. This policy is not applicable
...
>>>>>>> Stashed changes:src/static/privacy/Privacy.js
